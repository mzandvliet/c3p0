...
public class RealBot implements IBot {

	private static final Logger LOGGER = LoggerFactory.getLogger(RealBot.class);
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		MacdAnalysisConfig analysisConfig = new MacdAnalysisConfig(200,80,200); // Todo: trader.startDelay is proportional to this, maybe Max(fast,slow,signal)
		MacdTraderConfig traderConfig = new MacdTraderConfig(200, 0.3, -0.3, 0.5, 0.5, 600000, 600000);
		...
		IClock botClock = new RealtimeClock(clockTimestep);
